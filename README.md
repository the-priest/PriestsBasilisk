...
<img src="https://img.shields.io/badge/tests-5104%20assertions-2ea043?style=for-the-badge&labelColor=08090b&logo=pytest&logoColor=2ea043" alt="5104 assertions">
...
**Stdlib only** for the engine. No pytest, no network, no fixtures, no account — **5,104 assertions across 82 suites**, run in under a minute. Four of those suites are adversarial probes that report *findings* rather than a pass count, so their checks are not in that total.
...
### Built by one person, around a day job. Verified by 5,104 assertions. Priced at nothing.
