...
<img src="https://img.shields.io/badge/version-1.2.0.8-e11d2b?style=for-the-badge&labelColor=08090b" alt="version 1.2.0.8">
<img src="https://img.shields.io/badge/tests-5025%20assertions-2ea043?style=for-the-badge&labelColor=08090b&logo=pytest&logoColor=2ea043" alt="5025 assertions">
...
```bash
sudo apt install ./priestsbasilisk_1.2.0.8-1_all.deb
```

```bash
sudo pacman -U priestsbasilisk-1.2.0.8-1-any.pkg.tar.zst
```
...
**Stdlib only** for the engine. No pytest, no network, no fixtures, no account — **5,025 assertions across 82 suites**, run in under a minute. Four of those suites are adversarial probes that report *findings* rather than a pass count, so their checks are not in that total.
...
### Built by one person, around a day job. Verified by 5,025 assertions. Priced at nothing.
