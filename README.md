...
<img src="https://img.shields.io/badge/version-1.2.0.6-e11d2b?style=for-the-badge&labelColor=08090b" alt="version 1.2.0.6">
<img src="https://img.shields.io/badge/tests-4994%20assertions-2ea043?style=for-the-badge&labelColor=08090b&logo=pytest&logoColor=2ea043" alt="4994 assertions">
...
```bash
sudo apt install ./priestsbasilisk_1.2.0.6-1_all.deb
```

```bash
sudo pacman -U priestsbasilisk-1.2.0.6-1-any.pkg.tar.zst
```
...
**Stdlib only** for the engine. No pytest, no network, no fixtures, no account — **4,994 assertions across 82 suites**, run in under a minute. Four of those suites are adversarial probes that report *findings* rather than a pass count, so their checks are not in that total.
...
### Built by one person, around a day job. Verified by 4,994 assertions. Priced at nothing.
