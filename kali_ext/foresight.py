...
_CATASTROPHIC: List = [
    ...
    (re.compile(r"\b(fdisk|sfdisk|parted|gdisk)\b.*\b/dev/"),
    ...
    (re.compile(r"\b(:\(\)\s*\{\s*:\|\:&\s*\}\s*;|fork\s*bomb)"),
    ...
    (re.compile(r"\bchmod\s+-R\s+0*7{3}\s+/\b"),
...
_RISKY: List = [
    ...
    (re.compile(r"\b(passwd|usermod|chsh)\b"),
